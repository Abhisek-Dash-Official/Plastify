                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-linear-to-r from-green-600 to-emerald-600 text-white font-bold py-4 rounded-lg hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-all shadow-lg"
                            >
                                Send Message
                            </button>
                        </form>
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">123 Green Street, Eco City<br />Sustainable State, 12345</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">hello@plastify.com<br />support@plastify.com</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-linear-to-r from-green-600 to-emerald-600 rounded-2xl shadow-xl p-8 text-white">
                            ...
                            <p className="mb-6">Stay connected for updates and eco-tips!</p>
                            <div className="flex space-x-4">
                                <a href="#" className="bg-white text-green-600 rounded-full p-3 hover:scale-110 transition-transform">
